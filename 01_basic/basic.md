...
| 75–95 | พิมพ์ Example ใน `11_1` แล้วทำ Your turn/TODO ทุก STEP |
...
1. เด็กพิมพ์ Example ตามครูและอธิบายแต่ละบรรทัด
2. เด็กทำ Your turn/TODO ที่อยู่หลัง Example
3. ทายผลก่อน Run แล้วตรวจตาม Run Checkpoint
4. เปิด `answers` หลังลองทำเองแล้วเท่านั้น
...
Answer `11_2` Convert จาก Answer `09_2` โดยตรง: คำถาม ตัวแปร String และสูตร
เหมือนเดิม เปลี่ยนเฉพาะ `print()` เป็น Pygame Interface
